...
*/
		...
		)
	{
		// Calculate the position of this vertex on screen
		{
			...
			//vertexPosition_local += ((sin(g_elapsedSecondCount_total))/4.0);
	...
	//You can use whatever location you want for the output/input between the vertex/fragment shader as long as it matches.
